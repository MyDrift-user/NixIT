{
  ...
  in {
    nixosConfigurations = {
      ...
      "svgmdl-vwrd-01" = mkAppServer { name = "svgmdl-vwrd-01"; services = [ ./modules/services/vaultwarden { nixit.ipv4 = "10.10.20.25/24"; nixit.newt.enable = false; } ]; };  # vaultwarden password server (vault.lua.li) — Pangolin site not created yet
