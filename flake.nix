{
  ...
  in {
    nixosConfigurations = {
      ...
      "svgmdl-outl-02" = mkAppServer { name = "svgmdl-outl-02"; services = [ ./modules/services/outline    { nixit.ipv4 = "10.10.20.22/24"; nixit.outlineUrl = "https://idpa.mydrift.dev"; nixit.pangolin.resources = [{ key = "outline-idpa"; name = "Outline IDPA"; fullDomain = "idpa.mydrift.dev"; port = 3000; sso = true; healthPath = "/_health"; }]; } ]; };  # outline 2 → idpa.mydrift.dev (IDPA)
